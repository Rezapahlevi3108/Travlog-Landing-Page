        ...
        <div className="container mx-auto px-4">
            <div className="grid grid-cols-12 items-center">
                ...
                <div className="lg:col-span-8 col-span-12 flex flex-col sm:flex-row gap-5 lg:w-screen sm:w-auto lg:mt-0 sm:mt-16 mt-8">
                    <CardServices servicesImg="/src/assets/img/destination.png" title="Best Tour Guide" text="What looked like a small patch of purple grass, above five feet." />
                    <CardServices servicesImg="/src/assets/img/booking.png" title="Easy Booking" text="Square, was moving across the sand in their direction." />
                    <CardServices servicesImg="/src/assets/img/cloudy.png" title="Weather Forecast" text="What looked like a small patch of purple grass, above five feet." />
                </div>
            </div>
        </div>
    </div>
