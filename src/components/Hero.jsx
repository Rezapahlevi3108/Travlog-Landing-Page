        ...
        <div className="container mx-auto p-4 lg:py-16">
            <div className="grid grid-cols-12 items-center">
                <div className="col-span-12 lg:col-span-4 order-2 lg:order-1">
                    <div>
                        <button className="px-8 py-4 bg-white text-[#F85E9F] flex items-center gap-2 text-sm font-bold rounded-full mx-auto lg:mx-0 border">
                            Explore the world!
                            <img src="/src/assets/img/work.svg" alt="" />
                        </button>
                ...
                <div className="col-span-12 lg:col-span-8 order-1 lg:order-2">
                    <div>
                        <img src="/src/assets/img/hero.png" className="w-full" alt="" />
                    </div>
                </div>
                <div className="col-span-12 order-3 pt-20">
                    <div className="flex justify-center lg:justify-between gap-6 sm:gap-7 flex-wrap">
                        <div>
                            <img src="/src/assets/img/tripadvisor.svg" className="h-5 sm:h-8" alt="" />
                        </div>
                        <div>
                            <img src="/src/assets/img/expedia.svg" className="h-5 sm:h-8" alt="" />
                        </div>
                        <div>
                            <img src="/src/assets/img/booking.svg" className="h-5 sm:h-8" alt="" />
                        </div>
                        <div>
                            <img src="/src/assets/img/airbnb.svg" className="h-5 sm:h-8" alt="" />
                        </div>
                        <div>
                            <img src="/src/assets/img/rbitz.svg" className="h-5 sm:h-8" alt="" />
                        </div>
                    </div>
                </div>
            </div>
